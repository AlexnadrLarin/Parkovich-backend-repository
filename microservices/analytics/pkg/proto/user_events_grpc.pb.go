...
const (
	UserEventService_SaveEvent_FullMethodName = "/userevents.UserEventService/SaveEvent"
)
...
type UserEventServiceClient interface {
	SaveEvent(ctx context.Context, in *UserEvent, opts ...grpc.CallOption) (*SaveEventResponse, error)
}
...
func (c *userEventServiceClient) SaveEvent(ctx context.Context, in *UserEvent, opts ...grpc.CallOption) (*SaveEventResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SaveEventResponse)
	err := c.cc.Invoke(ctx, UserEventService_SaveEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserEventServiceServer interface {
	SaveEvent(context.Context, *UserEvent) (*SaveEventResponse, error)
...
func (UnimplementedUserEventServiceServer) SaveEvent(context.Context, *UserEvent) (*SaveEventResponse, error) {
...
func RegisterUserEventServiceServer(s grpc.ServiceRegistrar, srv UserEventServiceServer) {
	// If the following call pancis, it indicates UnimplementedUserEventServiceServer was
...
func _UserEventService_SaveEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserEvent)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserEventServiceServer).SaveEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserEventService_SaveEvent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserEventServiceServer).SaveEvent(ctx, req.(*UserEvent))
	}
...
var UserEventService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "userevents.UserEventService",
	HandlerType: (*UserEventServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SaveEvent",
			Handler:    _UserEventService_SaveEvent_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "user_events.proto",
}
